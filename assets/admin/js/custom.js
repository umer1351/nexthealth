...
function show_order_details(ele){
 ...
 $(document).ready(function() {
        ...
        $("body").on("submit", "#form-upload-user", function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "http://localhost/Nexthealth/Upload/import",
                data: data,
                dataType: 'json',
                contentType: false,
                cache: false,
 ...
 function order_edit_add_product() {
	...
	function closeForm() {
	  document.getElementById("myForm").style.display = "none";
		...
		$(document).ready(function() {
		    $('.order_edit_product_add').select2();
		});
		...
		$('#search_products').keyup(function(){
	          ...
	          {
	           $.ajax({
	            url:"http://localhost/Nexthealth/ManageOrder/ajaxsearchProducts",
	            method:"POST",
	            data:{query:query},
		...
		function remove_product_from_order(order_detail_id, order_id, product_id) {
			
	          
	           $.ajax({
	            url:"http://localhost/Nexthealth/ManageOrder/delete_product",
	            method:"POST",
	            data:{order_detail_id:order_detail_id, order_id:order_id, product_id:product_id},
	            success:function(data){
