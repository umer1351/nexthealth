...
$required_url_id = array_pop($uriSegments);
 $required_url_id = $this->uri->segment(3);
 $required_url = $this->uri->segment(2);
            ...
            <div class="categorySection">
               ...
               <div class="row">
                  <div class="col-lg-2 col-md-3 col-sm-3 col-12">
                           ...
                           <?php foreach ($get_brands as $key => $value) { ?>
                                <li class="has_submenu mainFirstLi brandl">
                                    <div class="form-check">
                                      <input class="form-check-input" <?php if(in_array($value->brand_name, $brands_array)){echo 'checked=""';} ?> type="checkbox" value="<?php echo str_replace(" " , "_", $value->brand_name); ?>" id="brands" onclick='brands_filter();' class="brands"  name="brands">
                     ...
                     <div class="priceSlider d-none" id="left-category-price">
                                       ...
                                       <div class="categoryProductDiv">
                                          ...
                                          <div class="categoryProductInfo">
                                             ...
                                             <div class="categoryProductPrice">
                                                ...
                                                <?php if(($single_product->discount_type != 0)){ ?>
                                                      <span class="special_price discounted colorBlue">
