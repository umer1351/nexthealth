...
<div class="main">
    <div class="content">
        <div class="cartoption">		
            ...
            <div class="shopping">
                <div class="shopleft">
                    <a href="<?php echo base_url('product') ?>"> Continue Shopping</a>
                </div>
                <div class="shopright">
                    <?php
                    ...
                    if (empty($customer_id)) {
                        ?>
                        <a href="<?php echo base_url('user_form') ?>"> Checkout</a>
                        <?php
                    } elseif (!empty($customer_id)) {
                        ?>
                        <a href = "<?php echo base_url('customer/shipping') ?>"> Checkout</a>
                        <?php
                    }
                    ?>
                </div>
