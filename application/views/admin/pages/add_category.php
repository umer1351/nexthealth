                        ...
                        <div class="control-group">
                         ...
                         <fieldset>
                            <legend style="text-align: center;">Category Hierarchy:</legend>
                             <div class="control-group">
                                <label class="control-label" for="textarea2">Is this parent category?</label>
                                 <div class="controls" style="Display:flex;">
                              
                                      <label><input type="radio" name="category_type" value="2" required>No</label>

                                      <label><input type="radio" name="category_type" value="1">Yes</label>
                            ...
                            <div class="control-group">
                                <label class="control-label" for="textarea2">Display on Homepage?</label>
                                <div class="controls" style="Display:flex;">
                              
                                      <label><input type="radio" name="home_page_display" value="0" required>No</label>

                                      <label><input type="radio" name="home_page_display" value="1">Yes</label>
                                    
                                </div>
                            </div>
                    <fieldset>
                            <legend style="text-align: center;">Category Placement:</legend>
                             <div class="control-group">
                             ...
                             <div class="control-group">
                                <label class="control-label" for="fileInput">Sort Order for homepage</label>
                                <div class="controls">
                                     <input class="span6 typeahead" id="homepage_sort" name="homepage_sort" type="number"/>          
                                </div>
                             </div>
                    </fieldset>
