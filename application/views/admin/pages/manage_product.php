            ...
            <div class="box-header" data-original-title>
                ...
                <div class="search">
                  <i class="bi bi-search"></i>                        
                    <input type="text" id="search_text1" class="form-control searchInputTag" placeholder="Search for Products" name="search1" style="margin: 10px 10px 0;z-index: 9999999;">
                  <div id="results"></div>  
                </div> 
                        ...
                        <tr>
                            ...
                            <td class="center">
                                <?php if($single_product->product_image != '0'){ ?>
                                          <img id="show-img" src="<?php echo base_url('uploads/thumbs/' . $single_product->product_image) ?>" class="img-fluid" style="width:100px;height:50px" alt="test">
                                          <?php }else{ ?>
                                             <img id="show-img" src="<?php echo base_url('uploads/thumbs/placeholder.jpg') ;?>" class="img-fluid"  style="width:100px;height:50px">
                                          <?php } ?>
                                <!-- <img src="<?php echo base_url('uploads/thumbs/'.$single_product->product_image);?>" /> -->
