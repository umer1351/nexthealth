...
<div id="content" class="span10">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('manage/brand') ?>">Manage Discounts</a></li>
    ...
    <div class="row-fluid sortable">        
        ...
        <div class="box span12">
            ...
            <div class="box-header" data-original-title>
                ...
                <h2><i class="halflings-icon user"></i><span class="break"></span>Manage Discounts</h2>
                        ...
                        foreach ($all_discounts as $single_slider) {
                            ...
                            <tr>
                                ...
                                <td class="center">
                                    ...
                                    <a class="btn btn-info" href="<?php echo base_url('manage/edit_special_discounts/' . $single_slider['id']); ?>">

                                        <i class="halflings-icon white edit"></i>  

                                    </a>

                                    <a class="btn btn-danger" href="<?php echo base_url('delete/special_discount/' . $single_slider['id']); ?>">
