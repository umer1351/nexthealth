...
<div id="content" class="span10">
    ...
    <div class="row-fluid sortable">		
        ...
        <div class="box span12">
            ...
            <form class="d-flex" role="search" method="post" action="<?php echo base_url()?>manage/order/1">

                <div class="search">

                      <i class="bi bi-search"></i>                        

                        <input type="text"  class="form-control searchInputTag" placeholder="Customer Name" name="cust_name" value="<?php if(isset($_POST['cust_name'])){echo $_POST['cust_name'];} ?>" >
                      ...
                      <i class="bi bi-search"></i>                        
                        ...
                        <input type="text"  class="form-control searchInputTag" placeholder="Customer Email" name="cust_email" value="<?php if(isset($_POST['cust_email'])){echo $_POST['cust_email'];} ?>" >
                      ...
                      <i class="bi bi-search"></i>                        
                        ...
                        <input type="text" class="form-control searchInputTag" placeholder="Customer Phone" name="cust_num" value="<?php if(isset($_POST['cust_num'])){echo $_POST['cust_num'];}else{echo '';} ?>">
                      ...
                      <i class="bi bi-search"></i>                        
                        ...
                        <input type="text"  class="form-control searchInputTag" placeholder="Order Number" name="ord_num" value="<?php if(isset($_POST['ord_num'])){echo $_POST['ord_num'];} ?>" > 
              ...
              <a href="<?php echo base_url()?>manage/order/"><button>Reset</button></a>
                ...
                <table width="100%" cellspacing="1" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr class="heading">
                            ...
                            <th style="width:14%;text-align:left; padding-left:4px;">Customer</th>

                            <th style="width:14%;text-align:left; padding-left:4px;">Payment method</th>

                            <th style="width:14%;text-align:left; padding-left:4px;">Order Type</th>
                        ...
                        <tr>
                            ...
                            <td class="clsleft"><?php if(!empty($value['customer']['customer_name'])){echo $value['customer']['customer_name'];}else{echo 'N/A';}  ?></td>

                            <td class="clsleft"><?php echo $value['payment_method']; ?></td>

                            <td class="clsleft"><?php if($value['order_type'] == '0'){ echo 'Guest';}elseif($value['order_type'] == '1'){ echo 'Registered Customer';}else{ echo 'Scheduled ';} ?></td>
                            ...
                            <td style="text-align:right;">
                                ...
                                <img src="https://nexthealth.pk/uploads/images/arrow-asc.png" border="0">
                            ...
                            <td>
                                ...
                                <form method="post" action="<?php echo base_url()?>manage/cancel_order" name="Reorder">
