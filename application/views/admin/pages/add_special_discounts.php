...
<div id="content" class="span10">
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <i class="icon-edit"></i>
            <a href="<?php echo base_url('add/customer')?>">Add Special Discounts</a>
        </li>
    </ul>
    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon edit"></i><span class="break"></span>Add Special Discounts</h2>
                <div class="box-icon">
            ...
            <div class="box-content">
                <form class="form-horizontal" action="<?php echo base_url('save/special_discounts');?>" method="post" enctype="multipart/form-data">
                    <fieldset>
