...
class Category extends CI_Controller
{
    ...
    public function save_category()
    {
        ...
        $data['home_page_display']    = $this->input->post('home_page_display');
        ...
        // $data['homepage_sort']        = $this->input->post('homepage_sort');
        ...
        $this->form_validation->set_rules('home_page_display', 'Homepage Display', 'trim');
